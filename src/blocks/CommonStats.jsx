...
const CommonStats = () => {
  return (
    <div className='flex flex-row gap-16 px-24 py-56 xxs:flex-col xxs:py-28 xxxs:px-12'>
      ...
      <Stat className={`flex-1`} maintext={'>85%'} sidetext={<>студентов нашли работу <br />во время и по окончании обучения</>} />
